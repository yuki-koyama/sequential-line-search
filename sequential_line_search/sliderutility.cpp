...
pair<VectorXd, VectorXd> enlargeSliderEnds(const VectorXd& x_1, const VectorXd& x_2, const double scale, const double minimum_length)
{
    ...
    const double t_1 = nloptUtility::compute(VectorXd::Constant(1, 1.0), VectorXd::Constant(1, scale), VectorXd::Constant(1, 0.0), objective, constraint_p, data.get(), nlopt::LN_COBYLA, 1000)(0);
    const double t_2 = nloptUtility::compute(VectorXd::Constant(1, 1.0), VectorXd::Constant(1, scale), VectorXd::Constant(1, 0.0), objective, constraint_n, data.get(), nlopt::LN_COBYLA, 1000)(0);
